...
Dans le fichier .env.prod, la valeur est / car on part du principe que le contenu du dossier "code/" sera à la racine du projet. Mais si c'est dans un autre dossier, il faudra mettre une valeur. 
CHEMIN_BASE= 
