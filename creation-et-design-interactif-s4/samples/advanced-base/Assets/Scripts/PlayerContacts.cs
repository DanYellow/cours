...
public class PlayerContacts : MonoBehaviour
{
    ...
    public bool HasHorizontalOppositeContact()
    {
    ...
    void OnDrawGizmos()
    {
        if (bc != null)
        {
            ...
            // Gizmos.DrawWireCube(
            //     new Vector2(bc.bounds.center.x, bc.bounds.max.y + (crushLengthDetection / 2)),
            //     new Vector2(bc.size.x * boxCastScaleX, crushLengthDetection)
            // );
            // Gizmos.DrawWireCube(
            //     new Vector2(bc.bounds.center.x, bc.bounds.min.y - (crushLengthDetection / 2)),
            //     new Vector2(bc.size.x * boxCastScaleX, crushLengthDetection)
            // );
            ...
            // Gizmos.DrawWireCube(
            //     new Vector2(bc.bounds.center.x, bc.bounds.max.y - (crushLengthDetection / 2)),
            //     new Vector2(bc.size.x * boxCastScaleX, crushLengthDetection + bc.size.y)
            // );
            // else
            // {
            //     Gizmos.DrawWireCube(
