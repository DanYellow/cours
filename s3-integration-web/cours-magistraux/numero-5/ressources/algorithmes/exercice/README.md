...
Pour récupérer l'index d'un élément, il existe les méthodes `.indexOf()` et `.lastIndexOf()`. Parallèlement, souvenez-vous qu'une chaîne de caractères est un tableau déguisé, il est donc possible d'appliquer une boucle directement dessus.
