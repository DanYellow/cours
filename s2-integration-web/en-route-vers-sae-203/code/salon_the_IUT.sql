...
INSERT INTO `client_attente` VALUES (1,'hello@test.fr');
/*!40000 ALTER TABLE `client_attente` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `client_attente_categorie`
--

DROP TABLE IF EXISTS `client_attente_categorie`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `client_attente_categorie` (
  `client_attente_id` int NOT NULL,
  `categorie_id` int NOT NULL,
  PRIMARY KEY (`client_attente_id`,`categorie_id`),
  KEY `IDX_8D5F67B4BA7467BE` (`client_attente_id`),
  KEY `IDX_8D5F67B4BCF5E72D` (`categorie_id`),
  CONSTRAINT `FK_8D5F67B4BA7467BE` FOREIGN KEY (`client_attente_id`) REFERENCES `client_attente` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_8D5F67B4BCF5E72D` FOREIGN KEY (`categorie_id`) REFERENCES `categorie` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `client_attente_categorie`
--

LOCK TABLES `client_attente_categorie` WRITE;
/*!40000 ALTER TABLE `client_attente_categorie` DISABLE KEYS */;
/*!40000 ALTER TABLE `client_attente_categorie` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-03-10 17:41:37
